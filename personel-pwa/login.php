...
<body data-bs-theme="light">
    ...
    <div id="login-page" class="login-screen">
        ...
        <div class="login-container">
            <div class="text-center mb-1">
                <div class="mb-4 d-flex justify-content-center align-items-center" style="height: 100px; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.03));">
                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 539 328" style="height: 100px; width: auto; max-width: 100%;">
                        <title>Puantör Logo</title>
                        <style>
                            .s0 { fill: #515051 } 
                            .s1 { fill: #00adee } 
                            .s2 { fill: #27436f } 
                        ...
                        <g id="katman 1">
                            <g id="&lt;Group&gt;">
                                <g id="&lt;Group&gt;">
                                    ...
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" class="s1" d="m316.5 301.5c-0.6 0.5-1.2 0.9-1.9 1.2q-1 0.4-2.2 0.4-1.6 0-2.9-0.7c-0.8-0.5-1.5-1.1-2.1-2q-0.7-1.3-0.7-3.1c0-1.1 0.2-2.2 0.7-3q0.8-1.4 2.1-2c0.9-0.5 1.8-0.7 2.9-0.7q1.1 0 2.2 0.4 1 0.4 1.8 1.2l0.7-0.7c-1.3-1.3-2.9-2-4.7-2q-1.9 0-3.5 0.9c-1 0.5-1.8 1.3-2.4 2.4q-0.9 1.5-0.9 3.5 0 2 0.9 3.6 0.9 1.6 2.4 2.4c1.1 0.6 2.2 0.9 3.5 0.9 0.9 0 1.8-0.2 2.6-0.5q1.2-0.5 2.3-1.4z"/>
                                    </g>
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" fill-rule="evenodd" class="s1" d="m332.9 297.3q0 2-0.9 3.6-0.8 1.5-2.4 2.4c-1 0.6-2.2 0.9-3.5 0.9q-1.9 0-3.4-0.9-1.6-0.9-2.5-2.4-0.8-1.6-0.8-3.6c0-1.2 0.3-2.4 0.8-3.5q0.9-1.5 2.5-2.4c1-0.6 2.1-0.9 3.4-0.9 1.3 0 2.5 0.3 3.5 0.9q1.6 0.9 2.4 2.4c0.6 1.1 0.9 2.3 0.9 3.5zm-1.1 0q0-1.6-0.8-2.9-0.7-1.3-2-2.1-1.3-0.7-2.9-0.7c-1 0-2 0.2-2.9 0.7q-1.2 0.8-2 2.1-0.7 1.3-0.7 2.9 0 1.7 0.7 3 0.8 1.3 2 2.1c0.9 0.5 1.9 0.7 2.9 0.7q1.6 0 2.9-0.7 1.3-0.8 2-2.1 0.8-1.3 0.8-3z"/>
                                    </g>
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" class="s1" d="m355.6 292.1c-1-1-2.2-1.5-3.9-1.5q-1.6 0-2.9 0.8-1.3 0.9-2 2.4-0.5-1.6-1.7-2.4c-0.9-0.6-1.9-0.8-3.1-0.8-0.9 0-1.8 0.2-2.6 0.7-0.8 0.4-1.4 1.1-1.9 1.9v-2.4h-1.1v13.1h1.2v-7.4c0-0.9 0.2-1.7 0.5-2.5q0.6-1.1 1.6-1.7 1.1-0.7 2.3-0.7 2 0 3.1 1.2 1 1.3 1 3.5v7.6h1.2v-7.4c0-0.9 0.2-1.7 0.5-2.5q0.6-1.1 1.6-1.7c0.7-0.5 1.5-0.7 2.3-0.7q2 0 3.1 1.2 1 1.3 1 3.5v7.6h1.2v-7.6q0-2.7-1.4-4.2z"/>
                                    </g>
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" class="s1" d="m362.5 302.6q-0.3-0.3-0.7-0.3c-0.2 0-0.5 0.1-0.6 0.3q-0.3 0.2-0.3 0.6 0 0.4 0.3 0.7c0.1 0.1 0.4 0.2 0.6 0.2q0.4 0 0.7-0.2 0.2-0.3 0.2-0.7 0-0.4-0.2-0.6z"/>
                                    </g>
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" class="s1" d="m372.9 302.5c-0.4 0.2-0.8 0.4-1.2 0.5q-0.6 0.2-1.1 0.2-1.4 0-2-0.8-0.5-0.8-0.5-2.4v-8.2h4.6v-1h-4.6v-4.1l-1.1 0.1v4h-2.8v1h2.8v8.2q0 2.1 0.8 3.2c0.5 0.6 1.5 1 2.8 1 0.9 0 1.8-0.3 2.7-0.7z"/>
                                    </g>
                                    <g id="&lt;Group&gt;">
                                        <path id="&lt;Compound Path&gt;" class="s1" d="m381.7 290.6q-1.5 0-2.7 0.8c-0.8 0.6-1.4 1.3-1.9 2.3v-2.9h-1v13.1h1.1v-6.7q0-1.5 0.6-2.8c0.4-0.8 0.9-1.5 1.6-2q1-0.7 2.2-0.7 1.2 0 2.3 0.6l0.5-1c-0.8-0.4-1.7-0.7-2.7-0.7z"/>
                                    </g>
                                </g>
                                <g id="&lt;Group&gt;">
                                    <g id="&lt;Group&gt;">
                ...
                <p class="login-subtitle">Personel hesabı ile giriş yapın</p>
            </div>
                ...
                <form id="loginForm">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <label class="form-check m-0" style="cursor: pointer;">
                            <input type="checkbox" id="rememberMe" class="form-check-input" style="cursor: pointer;">
                            <span class="form-check-label text-xs text-secondary" style="font-weight: 500; user-select: none;">Beni Hatırla</span>
                        </label>
                        <a href="javascript:void(0)" class="text-xs text-primary text-decoration-none hover-underline" style="font-weight: 600;">Şifremi Unuttum</a>
                    </div>
                    <button type="submit" class="btn-login w-100 mb-3">Giriş Yap</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        // Override app.showMainApp to redirect on login success
