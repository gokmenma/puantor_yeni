                ...
                <div class="card-header">
                    ...
                    <div class="col ms-5 me-5">
                        <div class="input-icon">
                            ...
                            <input type="text" id="authSearch" class="form-control form-control-rounded"
                                placeholder="Yetki veya kategori ara...">
                        </div>
                    </div>
                            ...
                            <div class="accordion-item mb-3 border-0 shadow-sm rounded-3 overflow-hidden">
                                <div class="accordion-header d-flex align-items-center bg-white"
                                    ...
                                    <button
                                        ...
                                        data-bs-target="#collapse-<?php echo $auth->id; ?>" aria-expanded="false"
                                        ...
                                        <div class="row g-3 mt-1 group-<?php echo $auth->id; ?>">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <label class="form-selectgroup-item w-100">
                                                    ...
                                                    <div
                                                        class="form-selectgroup-label d-flex align-items-center p-3 bg-white border-2">
                                                        <div class="me-3">
