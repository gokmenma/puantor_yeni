...
<div class="row mb-3">
    ...
    <div class="col-md-2">
        <label for="username" class="align-middle">Kullanıcı Adı</label>
    </div>
    <div class="col-md-4 mb-3">
        <input type="text" class="form-control" name="username" value="<?php echo $user->username ?? '' ?>" id="username" required>
    </div>
