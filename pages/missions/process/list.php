...
$missionObj = new MissionProcess();

use App\Helper\Helper;

$missions = $missionObj->getMissionProcessFirm($firm_id);
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-auto ms-auto">
                        <a href="#" class="btn btn-primary route-link" data-page="missions/process/manage">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $item->process_order; ?></td>
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item route-link" data-page="missions/process/manage&id=<?php echo $item->id ?>" href="#">
                                                    <i class="ti ti-edit icon me-3"></i> Güncelle
                                                </a>
                                                <a class="dropdown-item delete-mission-process" href="#" data-id="<?php echo $item->id ?>">
