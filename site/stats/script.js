!function() {
    ...
    function t(e, t) {
        if (/^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(r.hostname) || "file:" === r.protocol)
    ...
    for (var a, u = 0; u < n.length; u++)
        t.apply(this, n[u]);
    function p() {
        a !== r.pathname && (a = r.pathname,
        t("pageview"))
    }
    function c() {
        p()
    }
    var f, e = window.history;
    function d(e) {
        return e && e.tagName && "a" === e.tagName.toLowerCase()
    }
    e.pushState && (f = e.pushState,
    ...
    "prerender" === i.visibilityState ? i.addEventListener("visibilitychange", function() {
        ...
        if ("auxclick" !== e.type || e.button === v)
            return (t = function(e) {
                for (; e && (void 0 === e.tagName || !d(e) || !e.href); )
                    e = e.parentNode;
                return e
            }(e.target)) && t.href && t.href.split("?")[0],
            !function e(t, n) {
                if (!t || g < n)
                    return !1;
                if (y(t))
            ...
            }(t, 0) && (n = t) && n.href && n.host && n.host !== r.host ? w(e, t, {
    ...
    function w(e, t, n) {
        ...
        !function(e, t) {
            if (!e.defaultPrevented)
                return t = !t.target || t.target.match(/^_(self|parent|top)$/i),
                e = !(e.ctrlKey || e.metaKey || e.shiftKey) && "click" === e.type,
                t && e
        }(e, t) ? (a = {
            props: n.props
        },
        plausible(n.name, a)) : (a = {
            props: n.props,
            callback: i
        },
        plausible(n.name, a),
    ...
    function b(e) {
        if ("auxclick" !== e.type || e.button === v) {
            ...
            n && (r = h(n),
            t ? (r.props.url = t.href,
            w(e, t, r)) : ((e = {}).props = r.props,
            plausible(r.name, e)))
        }
    }
    function y(e) {
    ...
    i.addEventListener("submit", function(e) {
        var t, n = e.target, a = h(n);
        function r() {
            t || (t = !0,
            n.submit())
        }
        a.name && (e.preventDefault(),
        t = !1,
        setTimeout(r, 5e3),
        e = {
            props: a.props,
