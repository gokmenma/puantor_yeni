    ...
    var r, i, a, o, u, c, s, l, f, d, v, m, p, h, g, y, T, S, E, b, L, w, C, M, x, k, A, F, I, B, D, P, R, N, q, O, H, V, U, _, j, J, $, z, G, K, Q, W, X, Y, Z, ee, et, en, er, ei, ea, eo, eu, ec, es, el = e( () => {}
        ...
        y = function(e, t, n, r) {
            ...
            return function(o) {
                ...
                t.delta = a,
                t.rating = (u = t.value) > n[1] ? "poor" : u > n[0] ? "needs-improvement" : "good",
                e(t))
            }
        }
        ,
        ...
        F = function(e, t) {
            t = t || {},
            k(function() {
                var n, r = x(), i = h("FCP"), a = g("paint", function(e) {
                    e.forEach(function(e) {
                        "first-contentful-paint" === e.name && (a.disconnect(),
                        e.startTime < r.firstHiddenTime && (i.value = Math.max(e.startTime - p(), 0),
                        i.entries.push(e),
                        n(!0)))
                    })
                });
                a && (n = y(e, i, A, t.reportAllChanges),
                m(function(r) {
        ...
        B = function(e, t) {
            ...
            r = (r = t) || {},
            F(E(function() {
                var e, t = h("CLS", 0), i = 0, a = [], o = function(n) {
                ...
                u && (e = y(n, t, I, r.reportAllChanges),
                S(function() {
                    o(u.takeRecords()),
                    e(!0)
                }),
        ...
        O = function(e) {
            if (e.cancelable) {
                ...
                addEventListener("pointercancel", n, P)) : N(i, e)
            }
        }
        ,
        H = function(e) {
        ...
        U = function(e, t) {
            t = t || {},
            k(function() {
                var n, a = x(), u = h("FID"), c = function(e) {
        ...
        ea = function(e, t) {
            ...
            r = (r = t) || {},
            k(function() {
                var e, t = x(), i = h("LCP"), a = function(n) {
                    var r = n[n.length - 1];
                    r && r.startTime < t.firstHiddenTime && (i.value = Math.max(r.startTime - p(), 0),
                    i.entries = [r],
                    e())
    ...
    t( () => {
        ...
        function() {
            ...
            let t = []
              ...
              , c = () => {
                var e, n;
                if (0 === t.length || 1 !== a && Math.random() > a)
                    return;
                let o = ed()
                  , c = t.map(e => ({
                    id: e.id,
