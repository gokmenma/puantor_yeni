...
if ($_POST['action'] == "saveProject") {
    ...
    $data = [
        ...
        'city' => !empty($_POST['project_city']) ? Security::escape($_POST['project_city']) : 0,
        'town' => !empty($_POST['project_town']) ? Security::escape($_POST['project_town']) : 0,
        'status' => !empty($_POST['project_status']) ? Security::escape($_POST['project_status']) : 0,
