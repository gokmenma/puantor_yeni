        ...
        try {
            ...
            foreach ($sheetData as $key => $row) {
                ...
                $data = [
                    ...
                    "phone" => (isset($row["F"]) && trim((string)$row["F"]) !== "") ? Security::encrypt(trim((string)$row["F"])) : ($existingPerson ? $existingPerson->phone : ""),
                    "email" => (isset($row["G"]) && trim((string)$row["G"]) !== "") ? Security::encrypt(trim((string)$row["G"])) : ($existingPerson ? $existingPerson->email : ""),
