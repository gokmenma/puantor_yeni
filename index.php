...
function isMobile() {
    return preg_match("/(android|avantgo|blackberry|bolt|boost|cricket|docomo|fone|hiptop|mini|mobi|palm|phone|pie|tablet|up\.browser|up\.link|webos|wml)/i", $_SERVER["HTTP_USER_AGENT"]);
}

if (isMobile() && (!isset($_GET['view']) || $_GET['view'] !== 'desktop')) {
            ...
            <div class="preloader-content">
                <div class="preloader-card">
                    <div class="preloader-logo-container">
                        <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 187" class="preloader-logo">
                            <g id="katman 1">
                                <g id="&lt;Group&gt;">
                                    <g id="&lt;Group&gt;">
                                        <g id="&lt;Group&gt;">
