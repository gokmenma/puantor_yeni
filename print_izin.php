...
// Calculate work resume date (bitis_tarihi + 1 day)
$end_date = new DateTime($talep->bitis_tarihi);
$end_date->modify('+1 day');
$ise_baslama_tarihi = $end_date->format('d.m.Y');
...
<head>
    <meta charset="UTF-8">
    <title>Yıllık İzin Formu - <?php echo htmlspecialchars($person->full_name); ?></title>
    <style>
        body {
        ...
        <div class="box">
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="val"><?php echo htmlspecialchars($person->phone ?? '—'); ?></td>
                </tr>
                <tr>
