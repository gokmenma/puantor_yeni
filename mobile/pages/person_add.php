...
<div class="container px-0">
  ...
  <?php if ($message): ?>
    <?php $is_success = strpos($message, 'Hata') === false; ?>
    <div class="alert alert-<?php echo $is_success ? 'success' : 'danger'; ?> d-flex align-items-center mb-3" role="alert" style="border-radius: 14px;">
